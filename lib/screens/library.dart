...
class _LibraryPageState extends ConsumerState<LibraryPage> {
  ...
  void initState() {
    super.initState();
    hasInternet.addListener(_onInternetChange);
    _init();
  }

  void _onInternetChange() {
    if (mounted) setState(() {});
  }

  @override
  void dispose() {
    hasInternet.removeListener(_onInternetChange);
    super.dispose();
  }
            ...
            return Padding(
              ...
              child: ChoiceChip(
                ...
                shape: RoundedRectangleBorder(
                  ...
                  side: BorderSide(
                    color: isSelected ? AppTheme.accent : Colors.grey.shade800,
  ...
  Widget build(BuildContext context) {
    ...
    items = [
      ...
      if (!hasInternet.value)
        LibraryCardData(
          id: 'h_all',
          title: AppLocalizations.of(context).offlineTracks,
