            ...
            delegate: SliverChildListDelegate([
              SettingsRow(
                ...
                onDelete: () async {
                  ...
                  info('${l10n.lastPlayedSongs} ${l10n.clearedv}', Severity.success);
                },
              ),
              SettingsRow(
                ...
                onDelete: () async {
                  ...
                  info('${l10n.lastPlayedAlbums} ${l10n.clearedv}', Severity.success);
                },
              ),
              SettingsRow(
                ...
                onDelete: () async {
                  ...
                  info('${l10n.searchHistory} ${l10n.clearedv}', Severity.success);
                },
              ),
            ]),
          ),
            ...
            delegate: SliverChildListDelegate([
              SettingsRow(
                ...
                onDelete: () async {
                  ...
                  info(l10n.allOfflineSongsDeleted, Severity.success);
            ...
            delegate: SliverChildListDelegate([
              SettingsRow(
                ...
                onDelete: () async {
                  ...
                  info('${l10n.songs} ${l10n.clearedv}', Severity.success);
                },
              ),
              SettingsRow(
                ...
                onDelete: () async {
                  ...
                  info('${l10n.artist} ${l10n.clearedv}', Severity.success);
                },
              ),
              SettingsRow(
                ...
                onDelete: () async {
                  ...
                  info('${l10n.album} ${l10n.clearedv}', Severity.success);
                },
              ),
              SettingsRow(
                ...
                onDelete: () async {
                  ...
                  info('${l10n.playlists} ${l10n.clearedv}', Severity.success);
                },
              ),
            ]),
          ),
