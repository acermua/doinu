                          ...
                          WidgetSpan(
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                ...
                                final errPrefix = AppLocalizations.of(context).somethingWentWrongVisit;
                                try {
                                  await launchUrl(
                                    uri,
                                  ...
                                  if (await canLaunchUrl(uri)) {
                                    ...
                                    info(
                                      '$errPrefix https://doinuadmin.vercel.app/terms',
                                      Severity.error,
                                    );
                                  }
                                }
                              ...
                              onTap: () async {
                                ...
                                try {
                                  ...
                                  if (await canLaunchUrl(uri)) {
                                    ...
                                    info(
                                      '$errPrefix https://doinuadmin.vercel.app/privacy',
                                      Severity.error,
                                    );
                                  }
                                }
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      final cannotOpenMsg = AppLocalizations.of(context).cannotOpenLink;
                      try {
                        ...
                        if (await canLaunchUrl(uri)) {
                          ...
                          info(
                            '$cannotOpenMsg: https://play.google.com/store/apps/details?id=com.hiveminds.doinu',
                            Severity.error,
                          );
                        }
                      }
