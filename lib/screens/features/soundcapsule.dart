...
class _SoundCapsuleState extends ConsumerState<SoundCapsule> {
  ...
  Future<void> _init() async {
    ...
    // Moved to build for localization
  ...
  Widget build(BuildContext context) {
    // Calculate month string based on current locale
    final now = DateTime.now();
    final currentLocale = Localizations.localeOf(context).toString();
    final month = capitalize(DateFormat('MMMM', currentLocale).format(now));
    final monthYear = "$month ${now.year}";
          ...
          : CustomScrollView(
              ...
              slivers: [
                ...
                SliverAppBar(
                  ...
                  expandedHeight: 160,
                  elevation: 0,
                  backgroundColor: getDominantDarker(AppTheme.bg),
                      ...
                      children: [
                        ...
                        Text(
                          monthlyMinutes <= 0
                              ...
                              : AppLocalizations.of(context).listenedToMusicFor,
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 22,
                        ...
                        if (monthlyMinutes > 0)
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                AppLocalizations.of(context).minutesThisMonth,
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 22,
                                  fontWeight: FontWeight.w500,
                ...
                if (topArtists.isNotEmpty) ...[
                  SliverToBoxAdapter(
                    child: Text(
                      AppLocalizations.of(context).topArtistsCapsule,
                ...
                if (topalbums.isNotEmpty) ...[
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Text(
                        "${AppLocalizations.of(context).topAlbumsCapsule} $month",
                        style: TextStyle(
                          color: Colors.white70,
                          fontSize: 16,
                          fontWeight: FontWeight.w400,
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        "${topalbums[0].songs.length} ${AppLocalizations.of(context).songs}",
                                        style: const TextStyle(
                                          color: Colors.white54,
                                          fontSize: 12,
                                          fontWeight: FontWeight.w500,
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "${AppLocalizations.of(context).listenedTo} ${topalbums[0].title} ",
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 16,
                              fontWeight: FontWeight.w500,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${album.songs.length} ${AppLocalizations.of(context).songs} • ${album.year}",
                                      style: const TextStyle(
                                        color: Colors.white54,
                                        fontSize: 12,
                                        fontWeight: FontWeight.w500,
