                    ...
                    child: Row(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              AppLocalizations.of(context).freemium,
                              style: const TextStyle(
                                color: Colors.white70,
                                fontSize: 14,
                                fontWeight: FontWeight.w600,
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    AppLocalizations.of(context).benefitSnapshot,
                    style: const TextStyle(
                      color: Colors.white70,
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _buildBenefitItem(
                          AppLocalizations.of(context).benefitAdFree,
                        ),
                        _buildBenefitItem(
                          AppLocalizations.of(context).benefitOffline,
                        ),
                        _buildBenefitItem(
                          AppLocalizations.of(context).benefitQuality,
                        ),
                        _buildBenefitItem(
                          AppLocalizations.of(context).benefitQueue,
                        ),
                        _buildBenefitItem(
                          AppLocalizations.of(context).benefitSwipes,
                        ),
                      ],
                    ),
                  ),
