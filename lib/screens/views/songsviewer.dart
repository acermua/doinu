    ...
    try {
      if (widget.showLikedSongs) {
        ...
        for (int start = 0; start < total; start += batchSize) {
          ...
          final freshDetails = await sb.getSongDetails(ids: batchIds);
                ...
                children: [
                  ...
                  Text(
                    status == DownloadStatus.downloading
                        ? "$downloadedCount ${AppLocalizations.of(context).of} $total ${AppLocalizations.of(context).downloaded}"
      ...
      body: Container(
        ...
        child: _loading
            ...
            : CustomScrollView(
                ...
                slivers: _songs.isEmpty
                    ? SliverErrorState.build(
                        icon: widget.showLikedSongs
                            ? Icons.favorite_border
                            : Icons.music_note_outlined,
                        title: widget.showLikedSongs
                            ? AppLocalizations.of(context).noLikedSongsFound
                            : AppLocalizations.of(context).noSongsFound,
                        subtitle: widget.showLikedSongs
                            ? AppLocalizations.of(
                                context,
                              ).songsYouLikeWillAppearHere
                            : AppLocalizations.of(context).noSongsFound,
                        headerTitle: AppLocalizations.of(context).likedSongs,
                        headerSubtitle: AppLocalizations.of(
                          context,
                        ).yourFavoritesInOnePlace,
                      )
                    : [
                        SliverAppBar(
                          pinned: true,
