...
class _SleepTimerSheetState extends ConsumerState<SleepTimerSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final options = {
      SleepTimerOption.fiveMin: '5 ${l10n.minutes}',
      SleepTimerOption.tenMin: '10 ${l10n.minutes}',
      SleepTimerOption.fifteenMin: '15 ${l10n.minutes}',
      SleepTimerOption.twentyMin: '20 ${l10n.minutes}',
      SleepTimerOption.thirtyMin: '30 ${l10n.minutes}',
      SleepTimerOption.fortyFiveMin: '45 ${l10n.minutes}',
      SleepTimerOption.oneHour: '1 ${l10n.hour}',
      SleepTimerOption.endOfTrack: l10n.endOfTrack,
    };
